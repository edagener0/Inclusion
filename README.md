...
- [Base de Dados](#base-de-dados)
  - [Modelo Entidade Relação](#modelo-entidade-rela%C3%A7%C3%A3o)
  - [Modelo Relacional](#modelo-relacional)
- [Diagrama de arquitetura de alto nível de componentes](#diagrama-de-arquitetura-de-alto-n%C3%ADvel-de-componentes)
- [Contexto](#contexto)
- [Documentação de Épicos e User Stories](#documenta%C3%A7%C3%A3o-de-%C3%89picos-e-user-stories)
...
- [edagener0](https://github.com/edagener0): Martim Neves
- [Monstercreft](https://github.com/Monstercreft): Gabriel Vaz

## Frontend

- [jethroTLOU](https://github.com/jethroTLOU): Vadym Lemnaru
- [GuilhermeCarmo6](https://github.com/GuilhermeCarmo6): Guilherme Carmo
...
# Documentação de Épicos e User Stories
...
**Critérios de aceitação:** \* Dado que todos os dados fornecidos são válidos o utilizador fica registado com sucesso na plataforma.
...
**Como utilizador,** quero criar un post com uma imagem ou vídeo e uma descrição.
...
```bash
git clone https://github.com/edagener0/Inclusion.git
cd ./Inclusion

mv ./backend/.env.example ./backend/.env
nano ./backend/.env # Preencher as variáveis ambientais adequadamente

mv ./frontend/.env.example ./frontend/.env.production
nano ./frontend/.env.production # Preencher as variáveis ambientais adequadamente
...
Desenvolveu-se também competências de DevOps, ao criar Dockerfiles para o backend e frontend e por fim um docker compose que permite iniciar todos os serviços e aplicação.
